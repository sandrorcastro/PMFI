...
public partial class Fzponto
{
    ...
    public virtual ICollection<FztermoCredenciamento> FztermoCredenciamentos { get; set; } = new List<FztermoCredenciamento>();

    public virtual FztipoPonto? FztipoPonto { get; set; }

    public virtual ICollection<FzveiculoPorPonto> FzveiculoPorPontos { get; set; } = new List<FzveiculoPorPonto>();
