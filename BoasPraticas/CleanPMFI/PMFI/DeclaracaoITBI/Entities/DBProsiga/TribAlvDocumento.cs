...
public partial class TribAlvDocumento
{
    ...
    public DateOnly? DtDocumento { get; set; }
    ...
    public virtual ICollection<TribAlvDocumentoAreaConstrucao> TribAlvDocumentoAreaConstrucaos { get; set; } = new List<TribAlvDocumentoAreaConstrucao>();
