...
public partial class TribSimuladosIptuimovei
{
    ...
    public virtual ICollection<TribSimuladosIptuedifCarac> TribSimuladosIptuedifCaracs { get; set; } = new List<TribSimuladosIptuedifCarac>();

    public virtual ICollection<TribSimuladosIptutestada> TribSimuladosIptutestada { get; set; } = new List<TribSimuladosIptutestada>();
}
