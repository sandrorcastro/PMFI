...
public partial class TbDspLiquidacoesDocumento
{
    ...
    public virtual ICollection<TbDspLiquidacaoComunicacao> TbDspLiquidacaoComunicacaos { get; set; } = new List<TbDspLiquidacaoComunicacao>();

    public virtual ICollection<TbDspLiquidacoesDoctosIten> TbDspLiquidacoesDoctosItens { get; set; } = new List<TbDspLiquidacoesDoctosIten>();
