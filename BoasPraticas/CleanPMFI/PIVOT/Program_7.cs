    ...
    static void Main_7()
    {
        ...
        using (SqlConnection connection = new SqlConnection(connectionString))
        {
            ...
            while (reader.Read())
            {
                ...
                //if (!notificacoes.ContainsKey("TituloTributo")) notificacoes["TituloTributo"] = new List<string>();
                //results["Tributo"].Add(tributo);
            ...
            /*foreach (KeyValuePair<string, List<string>> kvp in notificacoes)
            {
