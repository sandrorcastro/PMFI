...
namespace Domain.Entities.DBProsiga
{
    ...
    {
        public TribAlvaraEmpresa()
        {
            TribAlvaraRenovacaoDivida = new HashSet<TribAlvaraRenovacaoDivida>();
            TribAlvaraRenovacaos = new HashSet<TribAlvaraRenovacao>();
        }
        ...
        public virtual ICollection<TribAlvaraRenovacao> TribAlvaraRenovacaos { get; set; }
    }
}
