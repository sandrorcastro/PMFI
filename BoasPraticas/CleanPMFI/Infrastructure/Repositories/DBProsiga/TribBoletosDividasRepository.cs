...
{
    public class TribBoletosDividasRepository : RepositoryBase<TribBoletosDivida>, ITribBoletosDividasRepository
    {
        private readonly IServiceScopeFactory _scopeFactory;
        public TribBoletosDividasRepository(IServiceScopeFactory ServiceScopeFactory, DBProsigaContext dbContext) : base(ServiceScopeFactory, dbContext)
        {
            _scopeFactory = ServiceScopeFactory;
        }
        /*public override async Task<TribBoletosDivida> AddAsync(TribBoletosDivida entity, CancellationToken cancellationToken = default)
        {
            ...
            using (var scope = ServiceScopeFactory.CreateAsyncScope())
            {
                ...
                await dbcontexto.Set<TribBoletosDivida>().AddAsync(entity);
