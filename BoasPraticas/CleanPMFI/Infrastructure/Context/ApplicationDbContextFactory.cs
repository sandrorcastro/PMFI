...
{
    //public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<MegaDataDBContext>
        public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
    //public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<NFSEDBContext>
    {
        /*public MegaDataDBContext CreateDbContext(string[] args)
        {
            ...
            var optionsBuilder = new DbContextOptionsBuilder<MegaDataDBContext>();
            ...
            return new MegaDataDBContext(optionsBuilder.Options);
        }*/
