...
public class TribItbidocumentoTipoSpec : SingleResultSpecification<TribItbidocumentoTipo>
{
   

  /*  public TribItbidocumentoTipoSpec(long? itbidicid,string? descricao)
    ...
    public TribItbidocumentoTipoSpec(string? descricao)
