...
namespace RP.SMF.Blazor.DBProsiga
{
    ...
    {
        public TribReducaoTributo()
        {
            TribReducaoTributosItens = new HashSet<TribReducaoTributosIten>();
        }
        ...
        public virtual ICollection<TribReducaoTributosIten> TribReducaoTributosItens { get; set; }
    }
}
