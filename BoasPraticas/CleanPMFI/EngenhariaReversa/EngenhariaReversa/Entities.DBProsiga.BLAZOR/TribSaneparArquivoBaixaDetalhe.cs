...
namespace RP.SMF.Blazor.DBProsiga
{
    ...
    {
        public TribSaneparArquivoBaixaDetalhe()
        {
            TribSaneparDivida = new HashSet<TribSaneparDivida>();
        }
        ...
        public virtual ICollection<TribSaneparDivida> TribSaneparDivida { get; set; }
    }
}
