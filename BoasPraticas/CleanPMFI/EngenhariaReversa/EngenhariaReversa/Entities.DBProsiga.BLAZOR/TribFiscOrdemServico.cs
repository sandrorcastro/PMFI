...
namespace RP.SMF.Blazor.DBProsiga
{
    ...
    {
        public TribFiscOrdemServico()
        {
            TribFiscOrdemServicoOcorrencia = new HashSet<TribFiscOrdemServicoOcorrencia>();
            TribFiscOsreclamacos = new HashSet<TribFiscOsreclamaco>();
        ...
        public virtual ICollection<TribFiscOsreclamaco> TribFiscOsreclamacos { get; set; }
