...
namespace EngenhariaReversa.Entities.GIIGRepositorioDB
{
    public partial class GIIGRepositorioDBContext : DbContext
    {
        ...
        public virtual DbSet<TbRepArq00000001> TbRepArq00000001s { get; set; } = null!;
        public virtual DbSet<TbRepArq00000002> TbRepArq00000002s { get; set; } = null!;
        public virtual DbSet<TbRepArquivo> TbRepArquivos { get; set; } = null!;
        public virtual DbSet<TbRepDadosArquivo> TbRepDadosArquivos { get; set; } = null!;
        public virtual DbSet<TbRepRepositorio> TbRepRepositorios { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=172.27.84.102;Initial Catalog=GIIGRepositorioDB;Persist Security Info=false;Integrated Security=False;Encrypt=False;TrustServerCertificate=False;User ID=rpdesenv;Password=visual");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TbRepArq00000001>(entity =>
            {
                entity.HasKey(e => e.IdArquivo)
                    .HasName("PK__tbRepArq__C91FC4C20AD2A005");
            ...
            {
                entity.HasKey(e => e.IdArquivo)
                    .HasName("PK__tbRepArq__C91FC4C20EA330E9");
            ...
            modelBuilder.Entity<TbRepDadosArquivo>(entity =>
            {
                ...
                entity.HasOne(d => d.IdRepositorioNavigation)
                    .WithMany(p => p.TbRepDadosArquivos)
