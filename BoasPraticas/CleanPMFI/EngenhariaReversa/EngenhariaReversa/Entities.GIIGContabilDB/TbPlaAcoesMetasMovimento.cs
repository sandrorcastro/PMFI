...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbPlaAcoesMetasMovimento()
        {
            TbPlaAcoesMetasMovimentosFontes = new HashSet<TbPlaAcoesMetasMovimentosFonte>();
        }
        ...
        public virtual ICollection<TbPlaAcoesMetasMovimentosFonte> TbPlaAcoesMetasMovimentosFontes { get; set; }
    }
}
