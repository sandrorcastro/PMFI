...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbPpaProgramasAco()
        {
            TbLdoMetasProgramasAcoesPpas = new HashSet<TbLdoMetasProgramasAcoesPpa>();
            TbPpaProgramasAcoesMeta = new HashSet<TbPpaProgramasAcoesMeta>();
        }
        ...
        public virtual ICollection<TbLdoMetasProgramasAcoesPpa> TbLdoMetasProgramasAcoesPpas { get; set; }
        public virtual ICollection<TbPpaProgramasAcoesMeta> TbPpaProgramasAcoesMeta { get; set; }
    }
}
