...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbPlaIndicadoresMovimento()
        {
            TbPlaMedidaEsperadaIndicadors = new HashSet<TbPlaMedidaEsperadaIndicador>();
        }
        ...
        public virtual ICollection<TbPlaMedidaEsperadaIndicador> TbPlaMedidaEsperadaIndicadors { get; set; }
    }
}
