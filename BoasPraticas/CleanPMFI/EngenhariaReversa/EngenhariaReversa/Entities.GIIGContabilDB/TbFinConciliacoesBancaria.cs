...
{
    public partial class TbFinConciliacoesBancaria
    {
        public TbFinConciliacoesBancaria()
        {
            TbFinConciliacoesBancariasObjetos = new HashSet<TbFinConciliacoesBancariasObjeto>();
        }
        ...
        public string? DsLoginBaixa { get; set; }
        ...
        public virtual TbFinDiarioTesourarium? IdLancamentoDiarioNavigation { get; set; }
        public virtual TbFinTiposConciliacao? IdTipoConciliacaoNavigation { get; set; }
        public virtual TbFinTiposDocumentoFinanceiro? IdTipoDocFinanceiroNavigation { get; set; }
        public virtual ICollection<TbFinConciliacoesBancariasObjeto> TbFinConciliacoesBancariasObjetos { get; set; }
    }
}
