...
{
    public partial class TbDspLiquidacoesDocumento
    {
        public TbDspLiquidacoesDocumento()
        {
            TbDspLiquidacaoComunicacaos = new HashSet<TbDspLiquidacaoComunicacao>();
            TbDspLiquidacoesDoctosItens = new HashSet<TbDspLiquidacoesDoctosIten>();
        ...
        public virtual TbDspCodigosFiscaisOperacoesPrestaco? CdCfopNavigation { get; set; }
        public virtual TbDspEstornosLiquidacao? IdEstornoNavigation { get; set; }
        ...
        public virtual ICollection<TbDspLiquidacaoComunicacao> TbDspLiquidacaoComunicacaos { get; set; }
        public virtual ICollection<TbDspLiquidacoesDoctosIten> TbDspLiquidacoesDoctosItens { get; set; }
