...
public class MegaDataLayoutNFSESpec : Specification<NfseTblNfse>
{
    ...
    {
        Query.Where(c => c.Dtcompetencia >= filter.DataInicial && c.Dtcompetencia < filter.DataFinal && c.Dtcompetencia!=null && c.Stsituacao=="A").Include(e=>e.Empresa); //.ApplyOrdering(filter).TagWith("Notas Fiscais No Período desejado!");
        //queryable.Join()
    }
}
