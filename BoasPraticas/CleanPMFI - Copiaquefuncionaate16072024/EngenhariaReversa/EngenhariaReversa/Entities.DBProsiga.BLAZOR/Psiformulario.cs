...
namespace RP.SMF.Blazor.DBProsiga
{
    ...
    {
        public Psiformulario()
        {
            InverseRefFormularioNavigation = new HashSet<Psiformulario>();
        ...
        public virtual ICollection<Psiformulario> InverseRefFormularioNavigation { get; set; }
