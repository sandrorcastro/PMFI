...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbRelParametrizaco()
        {
            TbRelParametrizacoesGrupos = new HashSet<TbRelParametrizacoesGrupo>();
        }
        ...
        public virtual ICollection<TbRelParametrizacoesGrupo> TbRelParametrizacoesGrupos { get; set; }
    }
}
