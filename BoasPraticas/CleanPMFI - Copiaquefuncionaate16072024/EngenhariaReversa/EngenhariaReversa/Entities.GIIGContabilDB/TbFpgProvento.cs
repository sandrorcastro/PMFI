...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbFpgProvento()
        {
            TbFpgProventosDescontos = new HashSet<TbFpgProventosDesconto>();
        }
        ...
        public virtual ICollection<TbFpgProventosDesconto> TbFpgProventosDescontos { get; set; }
    }
}
