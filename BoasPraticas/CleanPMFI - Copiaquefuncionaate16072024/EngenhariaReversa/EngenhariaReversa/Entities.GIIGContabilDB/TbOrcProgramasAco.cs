...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbOrcProgramasAco()
        {
            TbOrcDotacos = new HashSet<TbOrcDotaco>();
            TbOrcSubAcoesTarefas = new HashSet<TbOrcSubAcoesTarefa>();
            IdIniciativas = new HashSet<TbPlaIniciativa>();
        ...
        public virtual ICollection<TbOrcSubAcoesTarefa> TbOrcSubAcoesTarefas { get; set; }

        public virtual ICollection<TbPlaIniciativa> IdIniciativas { get; set; }
