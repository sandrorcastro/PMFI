...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbDspDocumentosFiscai()
        {
            TbDspDocumentosFiscaisItens = new HashSet<TbDspDocumentosFiscaisIten>();
        ...
        public virtual ICollection<TbDspDocumentosFiscaisIten> TbDspDocumentosFiscaisItens { get; set; }
