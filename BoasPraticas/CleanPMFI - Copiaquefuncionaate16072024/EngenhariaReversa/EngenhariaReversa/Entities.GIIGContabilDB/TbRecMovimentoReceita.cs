...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbRecMovimentoReceita()
        {
            TbRecMovimentoReceitasAportes = new HashSet<TbRecMovimentoReceitasAporte>();
        ...
        public virtual ICollection<TbRecMovimentoReceitasAporte> TbRecMovimentoReceitasAportes { get; set; }
