...
namespace EngenhariaReversa.Entities.GIIGContabilDB
{
    ...
    {
        public TbFinContasContabeisLancamento()
        {
            TbFinDiarioTesouraria = new HashSet<TbFinDiarioTesourarium>();
            TbFinInterferenciaFinanceiras = new HashSet<TbFinInterferenciaFinanceira>();
            TbFinLancamentosPartidaDobrada = new HashSet<TbFinLancamentosPartidaDobrada>();
            IdExtratos = new HashSet<TbFinExtratosBancario>();
        }
        ...
        public virtual ICollection<TbFinInterferenciaFinanceira> TbFinInterferenciaFinanceiras { get; set; }
        public virtual ICollection<TbFinLancamentosPartidaDobrada> TbFinLancamentosPartidaDobrada { get; set; }

        public virtual ICollection<TbFinExtratosBancario> IdExtratos { get; set; }
    }
}
