...
namespace EngenhariaReversa.Entities.DBProsiga
{
    ...
    {
        public TribSnarquivo()
        {
            TribSnarquivoDetalhes = new HashSet<TribSnarquivoDetalhe>();
        }
        ...
        public virtual ICollection<TribSnarquivoDetalhe> TribSnarquivoDetalhes { get; set; }
    }
}
