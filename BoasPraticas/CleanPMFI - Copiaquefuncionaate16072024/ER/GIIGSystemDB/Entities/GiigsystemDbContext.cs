...
public partial class GiigsystemDbContext : DbContext
{
    ...
    public virtual DbSet<TbGerAgendaTarefa> TbGerAgendaTarefas { get; set; }

    public virtual DbSet<TbGerAplicativo> TbGerAplicativos { get; set; }

    public virtual DbSet<TbSegChavesPublica> TbSegChavesPublicas { get; set; }

    public virtual DbSet<TbSegEmpresasGoverno> TbSegEmpresasGovernos { get; set; }

    public virtual DbSet<TbSegFormulario> TbSegFormularios { get; set; }

    public virtual DbSet<TbSegFormularioTipo> TbSegFormularioTipos { get; set; }

    public virtual DbSet<TbSegFormulariosComentario> TbSegFormulariosComentarios { get; set; }

    public virtual DbSet<TbSegGruposServico> TbSegGruposServicos { get; set; }

    public virtual DbSet<TbSegLogAcesso> TbSegLogAcessos { get; set; }

    public virtual DbSet<TbSegLogAutenticacao> TbSegLogAutenticacaos { get; set; }

    public virtual DbSet<TbSegModulo> TbSegModulos { get; set; }

    public virtual DbSet<TbSegModulosGruposServico> TbSegModulosGruposServicos { get; set; }

    public virtual DbSet<TbSegModulosPortal> TbSegModulosPortals { get; set; }

    public virtual DbSet<TbSegPerfisdeAcesso> TbSegPerfisdeAcessos { get; set; }

    public virtual DbSet<TbSegPerfisdeAcessoFormulario> TbSegPerfisdeAcessoFormularios { get; set; }

    public virtual DbSet<TbSegUsuario> TbSegUsuarios { get; set; }

    public virtual DbSet<TbSegUsuariosEmpresasModulo> TbSegUsuariosEmpresasModulos { get; set; }

    public virtual DbSet<TbSegUsuariosParametro> TbSegUsuariosParametros { get; set; }

    public virtual DbSet<TbSysFormulariosAtalho> TbSysFormulariosAtalhos { get; set; }

    public virtual DbSet<TbSysLogDado> TbSysLogDados { get; set; }

    public virtual DbSet<TbSysLogDadosTemp> TbSysLogDadosTemps { get; set; }

    public virtual DbSet<TbSysModulosAtualizaco> TbSysModulosAtualizacoes { get; set; }

    public virtual DbSet<TbSysPaginasEstado> TbSysPaginasEstados { get; set; }

    public virtual DbSet<TbSysParametro> TbSysParametros { get; set; }

    public virtual DbSet<TbSysRelatoriosChamada> TbSysRelatoriosChamadas { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=172.27.1.94;Initial Catalog=GIIGSystemDB;Integrated Security=False;Encrypt=False;TrustServerCertificate=False;User ID=gilberto.gc;Password=Couto2408@@");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbGerAplicativo>(entity =>
        {
            ...
            entity.HasOne(d => d.IdModuloNavigation).WithMany(p => p.TbGerAplicativos)
                .HasForeignKey(d => d.IdModulo)
                .HasConstraintName("FK_tbGerAplicativos_tbSegModulos");

            entity.HasMany(d => d.DsLogins).WithMany(p => p.IdAplicativos)
                .UsingEntity<Dictionary<string, object>>(
                    "TbGerAplicativosUsuario",
                    r => r.HasOne<TbSegUsuario>().WithMany()
                        .HasForeignKey("DsLogin")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_tbGerAplicativosUsuarios_tbSegUsuarios"),
                    l => l.HasOne<TbGerAplicativo>().WithMany()
                        .HasForeignKey("IdAplicativo")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_tbGerAplicativosUsuarios_tbGerAplicativos"),
                    j =>
                    {
                        j.HasKey("IdAplicativo", "DsLogin");
                        j.ToTable("tbGerAplicativosUsuarios");
                        j.IndexerProperty<string>("DsLogin")
                            .HasMaxLength(50)
                            .IsUnicode(false)
                            .HasColumnName("dsLogin");
                    });
        ...
        modelBuilder.Entity<TbSegFormulario>(entity =>
        {
            ...
            entity.HasOne(d => d.IdFormTipoNavigation).WithMany(p => p.TbSegFormularios)
                .HasForeignKey(d => d.IdFormTipo)
                .HasConstraintName("FK_tbSegFormularios_tbSegFormularioTipos");

            entity.HasOne(d => d.IdGrupoServicoNavigation).WithMany(p => p.TbSegFormularios)
                .HasForeignKey(d => d.IdGrupoServico)
                .HasConstraintName("FK_tbSegFormularios_tbSegGruposServicos");

            entity.HasOne(d => d.IdModuloNavigation).WithMany(p => p.TbSegFormularios)
                .HasForeignKey(d => d.IdModulo)
        ...
        modelBuilder.Entity<TbSegLogAcesso>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.DtLogOut, e.IdLog, e.DsLogin }, "IX_dtLogOut_IdLog_dsLogin").HasFillFactor(90);
        ...
        modelBuilder.Entity<TbSegLogAutenticacao>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.DsLogin, e.DtOcorrencia }, "IX_tbSegLogAutenticacao").HasFillFactor(90);
        ...
        {
            entity.HasKey(e => e.IdModulo).HasName("PK_tbSegModulo");
        ...
        modelBuilder.Entity<TbSegPerfisdeAcesso>(entity =>
        {
            ...
            entity.HasOne(d => d.IdModuloNavigation).WithMany(p => p.TbSegPerfisdeAcessos)
                .HasForeignKey(d => d.IdModulo)
        ...
        modelBuilder.Entity<TbSegPerfisdeAcessoFormulario>(entity =>
        {
            ...
            entity.HasOne(d => d.IdFormNavigation).WithMany(p => p.TbSegPerfisdeAcessoFormularios)
                .HasForeignKey(d => d.IdForm)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tbSegPerfisdeAcessoFormularios_tbSegFormularios");

            entity.HasOne(d => d.IdPerfilAcessoNavigation).WithMany(p => p.TbSegPerfisdeAcessoFormularios)
        ...
        {
            entity.HasKey(e => e.DsLogin).HasName("PK_tbSegUsuarios_1");

            entity.ToTable("tbSegUsuarios", tb => tb.HasTrigger("trgDesbloqueiaUsuarioResetSenha"));
            ...
            entity.HasOne(d => d.IdEmpresaPadraoNavigation).WithMany(p => p.TbSegUsuarios)
        ...
        modelBuilder.Entity<TbSegUsuariosEmpresasModulo>(entity =>
        {
            ...
            entity.HasOne(d => d.DsLoginNavigation).WithMany(p => p.TbSegUsuariosEmpresasModulos)
                .HasForeignKey(d => d.DsLogin)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tbSegUsuariosEmpresasModulo_tbSegUsuarios");

            entity.HasOne(d => d.IdEmpresaNavigation).WithMany(p => p.TbSegUsuariosEmpresasModulos)
                .HasForeignKey(d => d.IdEmpresa)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tbSegUsuariosEmpresasModulo_tbSegEmpresasGoverno");

            entity.HasOne(d => d.IdModuloNavigation).WithMany(p => p.TbSegUsuariosEmpresasModulos)
                .HasForeignKey(d => d.IdModulo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_tbSegUsuariosEmpresasModulo_tbSegModulos");

            entity.HasOne(d => d.IdPerfilAcessoNavigation).WithMany(p => p.TbSegUsuariosEmpresasModulos)
                .HasForeignKey(d => d.IdPerfilAcesso)
                .OnDelete(DeleteBehavior.ClientSetNull)
