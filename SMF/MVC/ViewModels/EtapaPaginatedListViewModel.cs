...
{
    public class EtapaPaginatedListViewModel : PaginatedList<Etapa>
    {
        public EtapaPaginatedListViewModel()
        {
            //  Sort = "Nome";
        }
        public EtapaPaginatedListViewModel(string sort, string filter)
        {
            Sort = sort;
            Filter = Filter;
        }
