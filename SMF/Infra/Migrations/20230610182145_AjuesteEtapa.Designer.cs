...
namespace Infra.Migrations
{
    ...
    [Migration("20230610182145_AjuesteEtapa")]
    partial class AjuesteEtapa
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Processo", b =>
                {
                    ...
                    b.Property<bool?>("ProcessoInativo")
                        .HasColumnType("bit");

                    b.Property<bool?>("ProcessoRecebido")
                        .HasColumnType("bit");

                    b.Property<long?>("ServidorExecutorId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Domain.Entities.Processo", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Servidor", "ServidorExecutor")
                        .WithMany("ExecutaProcessos")
                        .HasForeignKey("ServidorExecutorId")
                        .OnDelete(DeleteBehavior.NoAction);
